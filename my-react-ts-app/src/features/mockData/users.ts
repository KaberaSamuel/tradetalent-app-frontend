...
export const mockUsers: UserTypes[] = [
  {
    name: "Anya Sharma",
    first_name: "Anya",
    name_initials: "AS",
  ...
  },
  {
    ...
    about:
      "Full-stack developer specializing in e-commerce solutions. Skilled in React and Node.js, and enjoys building scalable web applications.",
    services_offered: "Web Development, SEO Optimization, Project Management",
    services_needed: "Video Editing, UI/UX Design, Content Writing",
    profile_image: "https://picsum.photos/seed/chenwei/200/200",
  },
  {
    name: "David Miller",
    first_name: "David",
  ...
  },
  {
    ...
    services_offered: "Digital Marketing, Social Media Management, Photography",
  ...
  },
  {
    ...
    about:
      "Chess coach and teacher with over 15 years of experience. I enjoy teaching students of all ages and skill levels, from beginners to advanced players.",
    services_offered: "Chess Coaching, Tutoring",
    services_needed: "Web/App Development, Photography",
    profile_image: "https://picsum.photos/seed/gracelee/200/200",
  },
  {
    name: "Hassan Khan",
    first_name: "Hassan",
